    ...
    return (
        ...
        <div className="about-text">
          ...
          <p>
            ...
            I happen to explore both the UX and logic part on the technologies front to build applications, 
            and I'm always looking for ways to optimize & improve ensuring fair functionality.
          </p>
          <p>About my career and academics, having recently completed CDAC'S PG diploma course in advanced computing,
            ...
            development tools, platforms, and frameworks, including React, Next.js, Java, Spring framework, 
            SQL | NoSQL databases & SpringToolSuite4 to name a few. Always eager to learn and explore new technologies on the go, 
            constantly seeking opportunities to improve my newly acquired skills and knowledge.</p>
        </div>
